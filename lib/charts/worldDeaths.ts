...
export async function initWorldDeaths(
	...
	try {
		...
		const geoData = await d3.json('https://raw.githubusercontent.com/nvkelso/natural-earth-vector/master/geojson/ne_110m_admin_0_countries.geojson') as { features: unknown[] };
